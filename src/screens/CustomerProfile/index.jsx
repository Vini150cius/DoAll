  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.titleContent}>Seu Perfil</Text>
        <View style={styles.perfilContainer}>
          <Image
            source={require("../../../assets/avatar.png")}
            style={styles.perfilImageContent}
          />
          <Text style={styles.nameCustomerContent}>Cliente</Text>

          <Text style={styles.emailCustomerContent}>cliente@gmail.com</Text>
        </View>
      </View>
    </SafeAreaView>
  );
